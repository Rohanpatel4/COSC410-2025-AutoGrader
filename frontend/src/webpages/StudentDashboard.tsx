  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      <>
        {/* Alert Messages */}
        {msg && (
          <div className={`p-4 rounded-xl mb-6 ${msg.toLowerCase().includes("fail") || msg.toLowerCase().includes("failed") ? "bg-red-900/50 border border-red-700 text-red-200" : "bg-green-900/50 border border-green-700 text-green-200"}`}>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="card bg-card text-card-foreground border border-border">
            ...
            <p className="text-muted-foreground mb-6">
              Enroll in new courses using an enrollment key from your instructor.
            </p>
